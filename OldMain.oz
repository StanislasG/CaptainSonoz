			...
			local ID Pos Direction in
				...
				if (Direction==surface) then 
					...
					local IDfire Item in
						...
						[] missile(PosMiss)	then Message in %todo sayDamageTaken and sayDeath for mine and missile
					...
					local IDmine Mine in
						...
						case Mine 
							...
							[] pt(x:_ y:_) 	then Message in 
								...
								{Send GuiPort removeMine(IDmine Mine)} 
								%todo sayDammageTaken and sayDeath for mine and missile
						end
					end
